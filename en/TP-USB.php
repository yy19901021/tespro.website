		...
		<table class="TwoColsLayout">
			<tr><td class="Left">
				...
				<ul>
					...
					<li>TP-USB-ANSI-N: Compatible with ANSI C12.18 (Siemens Standard)</li>
					<li>TP-USB-ANSI-N: Compatible with ANSI C12.18 (Universal, can be switch between Normal and Siemens standar)</li>
				</ul>
