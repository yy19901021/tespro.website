		...
		<table class="TwoColsLayout">
			<tr><td class="Left">
				...
				<table id="SpecTable" class="List">
					...
					<tr>
						<td>Fastening:</td><td>Magnetic adhesion supported by <a href="en/TP-GS08.php">TP-GS08</a>.</td>
					</tr>
					<tr>
				...
				<table id="OptionTable" class="List">
					...
					<col span="1" />
					<tbody>
					<tr><th>Supporter:</th><td>TP-GS Versatile Probe Fixture, providing magnetic adhesion for all kinds of meters. Please refer to <a href="en/TP-GS08.php">TP-GS Versatile Probe Fixture</a>.</td></tr>
