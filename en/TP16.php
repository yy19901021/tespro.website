		...
		<table class="TwoColsLayout">
			<tr><td class="Left">
				...
				<table id="OptionTable" class="List">
					...
					<col span="1" />
					<tbody>
					<tr><th>Supporter:</th><td>TP-GS Versatile Probe Fixture, providing magnetic adhesion to all kinds of meters. Please refer to <a href="en/TP-GS.php">TP-GS Versatile Probe Fixture</a>.</td></tr>
