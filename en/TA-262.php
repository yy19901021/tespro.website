	...
	<div class="Products">
		...
		<table class="TwoColsLayout">
			<tr><td class="Left">
				...
				<h3>Configuration</h3>
				<p>The TA-262 Communication Port Tester is composed of 2680A Hand Held Terminal (HHT), IM261 extended module and TATESTxx program.</p>
				<h3>Applications</h3>
				<ul>
				...
				<ul>
					...
					<li>Protocols Supported: IEC 62056-21(1107), dlms, IEC 60870-5-102, DL/T645, EDMI-MK6, Elster-Alpha, etc..<br />
					</li>
					<li>Baud Rate: 300-19200bps available and support automatic baud-rate detection supported.</li>
