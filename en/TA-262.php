		...
		<div class="row">
			<div class="col-md-7"><!-- Left Column -->				
				...
				<ul>
					...
					<li>Integrated with main program of TATESTxx</li>
         	<li>RS485 A-B static voltage detected</li>
         	<li>Special test cable with RJ45 for RS232 serial port and Actaris meter port connections and testing.</li>
        	<li>Special test cable with RJ11-6P for the port of Landis+Gyr meter port connections and testing.</li>
        	<li>Special test cable with two-pins for normal meter terminal connection and testing.</li>
