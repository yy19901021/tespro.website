<?php 
	$title = "TesPro: TA-261 Meter Communication Port Tester";
?>
<?php 
	$BaseUrl = "";
...
<div id="Content"><!--Start of content-->
	<div class="Products">
		<h1>TA-261 Meter Communication Port Tester<br /> - The &ldquo;Meter Almighty&rdquo; in AMR applications (Patented product)</h1>
		<table class="TwoColsLayout">
			<tr><td class="Left">
				...
				<h3>Configuration</h3>
				<p>The TA-261 Communication Port Tester is composed of 2680A Hand Held Terminal (HHT), IM261 extended module, TATESTxx program and testing cable.</p>
				<h3>Applications</h3>
				<ul>
					<li>The TA-261 tester can be used for communication port functionality test.</li>
