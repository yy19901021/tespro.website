<?php 
	$title = "TesPro: TP-17 Optical Scanning Probe with Duplex-function ";
?>
<?php 
	$BaseUrl = "";
		...
		<table class="TwoColsLayout">
			<tr><td class="Left">
				...
				<table id="SpecTable" class="List">
					...
					<col span="1" />
					<tbody>
					<tr><th>Power supply:</th><td>5V/12VDC.</td></tr>
				...
				<p>Note: Must work with <a href="en/TP-GS08.php">TP-GS08 Versatile Fixture</a> as supporter</p>
			</td><td class="Right">
