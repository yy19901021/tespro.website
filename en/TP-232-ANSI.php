		...
		<table class="TwoColsLayout">
			<tr><td class="Left">
				...
				<table id="ModelTable" class="List">
					...
					<col span="1" />
					<tbody>
						<tr><th>TP-232-ANSI-N</th><td>For standard ANSI meters, including GE, Elster…etc..</td></tr>
						<tr><th>TP-232-ANSI-S</th><td>For SIEMENS and EDMI meters.</td></tr>
						<tr><th>TP-232-ANSI-U</th><td>Universal, works with all ANSI standard meters.</td></tr>
					</tbody>
				</table>
				...
				<table id="SpecTable" class="List">
					...
					<tr><th>Maximum B.R.:</th><td>Up to 19200bps.</td></tr>
				...
				<img src="images/products/product_TP-232-ANSI.jpg" alt="TP-232-ANSI Optical Probe" />
			</td></tr>
		</table>
