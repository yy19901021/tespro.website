...
<div id="Content"><!--Start of content-->
	<div class="Products">
		...
		<div class="HalfWidth LeftAligned">
			...
			<ul>
				<li>TA-262 Portable Tester for Meter Com-port failure</li>
			</ul>
		</div>
		<div class="Clear"></div>
		<div class="HalfWidth LeftAligned">
		...
		<div class="HalfWidth LeftAligned">
			<h2 title="Meter Test Stand and Jigs">Meter Test Stand and Jigs</h2>
			<ul>
		...
		<div class="HalfWidth LeftAligned">
			<h2 title="Testing Devices">Meter Power Supply</h2>
			<ul>
				...
				<li><a href="TD-50-100A.php">TD-50-100A  3-P 100A Power Supply for Meter Reliability Test</a></li>
				-->
			</ul>
		</div>
		<div class="Clear"></div>
